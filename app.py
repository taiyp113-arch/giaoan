...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Văn Tài - Trường PTDTBT Tiểu học Giáp Trung - ĐT: 0852 392 603</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Văn Tài - Trường PTDTBT Tiểu học Giáp Trung - ĐT: 0852 392 603</div>", unsafe_allow_html=True)
